...
- Forgot to change `module` itself to `node16`.

## [2.2.0] - 2026-01-19

### Fixed

- The pre-commit template has been fixed, the build and lint stages were broken.

### Changed

- target/lib are now es2024 and moduleResolution is now node16 (was just node).
  The latter is a preparation for typescript 6+.
